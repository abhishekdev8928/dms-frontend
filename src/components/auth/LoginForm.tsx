  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="border-0 shadow-none py-[60px] lg:py-1">
        <CardHeader>
          <CardTitle className="text-[30px] text-[#035C4C] lg:text-left text-center">Welcome back</CardTitle>
          <CardDescription className="text-[16px] text-[#535353] lg:text-left text-center">
          ...
          >
            <FieldGroup>
              <Field className="gap-2">
                <FieldLabel htmlFor="email" className="text-[16px] font-bold text-[#374151]">Email Address</FieldLabel>
                <Input
                  id="email"
                  type="email"
                  className="selection:bg-[#E5E7EB] bg-[#F9FAFB] p-[26px] text-[14px] focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none border-0"
              ...
              <Field className="gap-2">
                <div className="flex items-center">
                  <FieldLabel htmlFor="password"  className="text-[16px] font-bold text-[#374151]">Password</FieldLabel>
                ...
                {errors.password && (
                  ...
                  <span><input  className="mr-2" type="checkbox" name="" id="" />Remember me </span>
                  <a
                    href="/auth/forgot-password"
                    className="ml-auto inline-block text-sm text-[#006EBD] underline-offset-4 hover:underline"
                  >
              ...
              <Field>
                ...
                <p className="text-center mt-4">Don't have an account? <a href="#!" className="text-[#006EBD]">Contact Admin</a></p>
