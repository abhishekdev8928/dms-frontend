...
const fileTypes = [
  ...
  { value: "docs", label: "Docs", icon:(<svg width="15" height="19" viewBox="0 0 15 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.13411 0.800051H2.46745C2.02542 0.800051 1.6015 0.975646 1.28894 1.28821C0.976376 1.60077 0.800781 2.02469 0.800781 2.46672V15.8001C0.800781 16.2421 0.976376 16.666 1.28894 16.9786C1.6015 17.2911 2.02542 17.4667 2.46745 17.4667H12.4674C12.9095 17.4667 13.3334 17.2911 13.646 16.9786C13.9585 16.666 14.1341 16.2421 14.1341 15.8001V5.80005M9.13411 0.800051C9.39791 0.799624 9.65918 0.851387 9.90289 0.952359C10.1466 1.05333 10.3679 1.20152 10.5541 1.38838L13.5441 4.37838C13.7315 4.56464 13.8801 4.78617 13.9814 5.03019C14.0826 5.2742 14.1345 5.53586 14.1341 5.80005M9.13411 0.800051V4.96672C9.13411 5.18773 9.22191 5.39969 9.37819 5.55597C9.53447 5.71225 9.74643 5.80005 9.96745 5.80005L14.1341 5.80005" stroke="#434343" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
) },
  { value: "folder", label: "Folders", icon:(<svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="relative inline-flex items-center">
          <select
            ...
            className="appearance-none  px-5 pr-8 py-3 text-[16px] text-[#434343] bg-white border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-0 focus:ring-none focus:border-transparent cursor-pointer hover:bg-gray-50"
          >
            {fileTypes.map((type) => (
          ...
          <svg width="10" className="absolute right-3 top-1/2 -translate-y-1/2 h-3 w-3 text-gray-400 pointer-events-none" height="5" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Popover open={openPeople} onOpenChange={setOpenPeople}>
          <PopoverTrigger asChild>
            <Button
              ...
              className="h-12 justify-between  [&_svg:not([class*='size-'])]:size-3.5 text-[16px] text-[#434343] bg-white hover:bg-gray-50 min-w-[200px]"
            >
              ...
              {/* <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" /> */}
                  <svg width="10" className="block h-[16px] w-[16px] text-gray-400 pointer-events-none" height="5" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg">
          <mask id="path-1-inside-1_381_583" fill="white">
          <path d="M0 0L5 5L10 0"/>
          </mask>
          <path d="M0 0L5 5L10 0" fill="#434343"/>
